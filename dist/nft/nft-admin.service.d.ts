...
export declare class NftAdminService {
    ...
    private nftService;
    private connection;
    constructor(nftCollectionRepo: Repository<NftCollection>, nftTypeRepo: Repository<NftType>, storeConfigRepo: Repository<StoreConfig>, solanaContractService: SolanaContractService, nftService: NftService);
    ...
    prepareCreateCollection(adminPublicKey: string, dto: CreateCollectionDto, imageFile: Express.Multer.File): Promise<any>;
    prepareInitializeMarketplace(adminPublicKey: string, feeBps?: number): Promise<any>;
    checkMarketplaceStatus(): Promise<any>;
    prepareCreateType(adminPublicKey: string, dto: CreateTypeDto, files: {
        mainImage?: Express.Multer.File[];
        additionalImages?: Express.Multer.File[];
    }): Promise<any>;
    prepareMintNft(collectionAdminPublicKey: string, collectionName: string, typeName: string, collectionMintAddress: string, buyerPublicKey: string): Promise<any>;
