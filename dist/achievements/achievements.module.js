...
exports.AchievementsModule = AchievementsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([task_entity_1.Task, user_task_entity_1.UserTask, user_entity_1.User])],
        controllers: [achievements_controller_1.AchievementsController],
        providers: [achievements_service_1.AchievementsService, task_validator_service_1.TaskValidatorService],
        exports: [achievements_service_1.AchievementsService, task_validator_service_1.TaskValidatorService],
    })
], AchievementsModule);
